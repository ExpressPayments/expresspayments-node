...
describe('ApplicationFee Resource', () => {
  describe('list', () => {
    it('Sends the correct request', () => {
      expressPlatby.applicationFees.list();
  ...
  describe('refunds', () => {
    it('Sends the correct update request', () => {
      expressPlatby.applicationFees.updateRefund(
        'appFeeIdExample3242',
        'refundIdExample2312',
        {metadata: {key: 'value'}}
      );
    ...
    it('Sends the correct create request', () => {
      expressPlatby.applicationFees.createRefund('appFeeIdExample3242', {amount: 100});
      expect(expressPlatby.LAST_REQUEST).to.deep.equal({
        method: 'POST',
    ...
    it('Sends the correct list request', () => {
      expressPlatby.applicationFees.listRefunds('appFeeIdExample3242');
      expect(expressPlatby.LAST_REQUEST).to.deep.equal({
        method: 'GET',
        url: '/v1/application_fees/appFeeIdExample3242/refunds',
        data: {},
    ...
    it('Sends the correct retrieve request', () => {
      expressPlatby.applicationFees.retrieveRefund(
        'appFeeIdExample3242',
        'refundIdExample2312'
      );
      expect(expressPlatby.LAST_REQUEST).to.deep.equal({
