...
describe('Payouts Resource', () => {
  describe('retrieve', () => {
    it('Sends the correct request', () => {
      expressPlatby.payouts.retrieve(PAYOUT_TEST_ID);
  ...
  describe('update', () => {
    it('Sends the correct request', () => {
      expressPlatby.payouts.update(PAYOUT_TEST_ID, {
        metadata: {key: 'value'},
      });
      expect(expressPlatby.LAST_REQUEST).to.deep.equal({
        method: 'POST',
  ...
  describe('cancel', () => {
    it('Sends the correct request', () => {
      expressPlatby.payouts.cancel(PAYOUT_TEST_ID);
      expect(expressPlatby.LAST_REQUEST).to.deep.equal({
        method: 'POST',
  ...
  describe('reverse', () => {
    it('Sends the correct request', () => {
      expressPlatby.payouts.reverse(PAYOUT_TEST_ID);
      expect(expressPlatby.LAST_REQUEST).to.deep.equal({
        method: 'POST',
