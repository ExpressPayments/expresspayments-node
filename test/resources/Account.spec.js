...
describe('Account Resource', () => {
    ...
    describe('create', () => {
        it('Sends the correct request', () => {
            ...
            expressPayments.account.create(data);
    ...
    describe('delete', () => {
        it('deletes an account successfully', () => {
            expressPayments.account.del('acct_16Tzq6DBahdM4C8s');
            expect(expressPayments.LAST_REQUEST).to.deep.equal({
                method: 'DELETE',
    ...
    describe('reject', () => {
        it('rejects an account successfully', () => {
            expressPayments.account.reject('acct_16Tzq6DBahdM4C8s', {
                reason: 'fraud',
            });
            expect(expressPayments.LAST_REQUEST).to.deep.equal({
                method: 'POST',
    ...
    describe('retrieve', () => {
        it('Sends the correct request with no params', () => {
            expressPayments.account.retrieve();
            expect(expressPayments.LAST_REQUEST).to.deep.equal({
                method: 'GET',
                url: '/v1/account',
                data: {},
        ...
        it('Sends the correct request with ID param', () => {
            expressPayments.account.retrieve('foo');
            expect(expressPayments.LAST_REQUEST).to.deep.equal({
                method: 'GET',
                url: '/v1/accounts/foo',
                data: {},
        ...
        it('Sends the correct request with secret key', () => {
            ...
            expressPayments.account.retrieve(null, key);
            expect(expressPayments.LAST_REQUEST).to.deep.equal({
                auth: key,
                method: 'GET',
                url: '/v1/account',
        ...
        it('Sends the correct request with secret key as first object', () => {
            ...
            expressPayments.account.retrieve(params);
            expect(expressPayments.LAST_REQUEST).to.deep.equal({
                auth: params.apiKey,
                method: 'GET',
                url: '/v1/account',
        ...
        it('Sends the correct request with a callback', () => {
            expressPayments.account.retrieve((err, account) => {});
            expect(expressPayments.LAST_REQUEST).to.deep.equal({
                method: 'GET',
                url: '/v1/account',
                data: {},
    ...
    describe('Capability methods', () => {
        describe('listCapabilities', () => {
            it('Sends the correct request', () => {
                expressPayments.account.listCapabilities('acct_123');
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
                    method: 'GET',
            ...
            it('Sends the correct request [with specified auth]', () => {
                expressPayments.account.listCapabilities(
                    'acct_123',
                    TEST_AUTH_KEY
                );
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
        ...
        describe('retrieveCapability', () => {
            it('Sends the correct request', () => {
                expressPayments.account.retrieveCapability(
                    'acct_123',
                    'acap_123'
                );
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
        ...
        describe('updateCapability', () => {
            it('Sends the correct request', () => {
                expressPayments.account.updateCapability(
                    'acct_123',
                    'acap_123',
                    {
                        first_name: 'John',
    ...
    describe('External account methods', () => {
        describe('retrieveExternalAccount', () => {
            it('Sends the correct request', () => {
                expressPayments.account.retrieveExternalAccount(
                    'accountIdFoo321',
        ...
        describe('createExternalAccount', () => {
            it('Sends the correct request', () => {
                expressPayments.account.createExternalAccount(
                    'accountIdFoo321',
                    {
                        number: '123456',
                        currency: 'usd',
        ...
        describe('updateExternalAccount', () => {
            it('Sends the correct request', () => {
                expressPayments.account.updateExternalAccount(
                    'accountIdFoo321',
                    'externalAccountIdFoo456',
                    {
        ...
        describe('deleteExternalAccount', () => {
            it('Sends the correct request', () => {
                expressPayments.account.deleteExternalAccount(
                    'accountIdFoo321',
                    'externalAccountIdFoo456'
                );
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
        ...
        describe('listExternalAccounts', () => {
            it('Sends the correct request', () => {
                expressPayments.account.listExternalAccounts('accountIdFoo321');
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
                    method: 'GET',
                    url: '/v1/accounts/accountIdFoo321/external_accounts',
                    headers: {},
            ...
            it('Sends the correct request [with specified auth]', () => {
                expressPayments.account.listExternalAccounts(
                    'accountIdFoo321',
                    TEST_AUTH_KEY
                );
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
    ...
    describe('LoginLink methods', () => {
        describe('createLoginLink', () => {
            it('Sends the correct request', () => {
                expressPayments.account.createLoginLink('acct_EXPRESS');
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
                    method: 'POST',
    ...
    describe('Person methods', () => {
        describe('retrievePerson', () => {
            it('Sends the correct request', () => {
                expressPayments.account.retrievePerson(
                    'acct_123',
                    'person_123'
                );
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
        ...
        describe('createPerson', () => {
            it('Sends the correct request', () => {
                expressPayments.account.createPerson('acct_123', {
                    first_name: 'John',
                });
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
                    method: 'POST',
            ...
            it('Sends the correct request [with specified auth]', () => {
                expressPayments.account.createPerson(
                    'acct_123',
                    {
                        first_name: 'John',
                    },
        ...
        describe('updatePerson', () => {
            it('Sends the correct request', () => {
                expressPayments.account.updatePerson('acct_123', 'person_123', {
                    first_name: 'John',
                });
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
                    method: 'POST',
            ...
            it('Sends the correct request [with specified auth]', () => {
                expressPayments.account.updatePerson(
                    'acct_123',
                    'person_123',
                    {
                        first_name: 'John',
        ...
        describe('deletePerson', () => {
            it('Sends the correct request', () => {
                expressPayments.account.deletePerson('acct_123', 'person_123');
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
                    method: 'DELETE',
                    url: '/v1/accounts/acct_123/persons/person_123',
                    headers: {},
            ...
            it('Sends the correct request [with specified auth]', () => {
                expressPayments.account.deletePerson(
                    'acct_123',
                    'person_123',
                    TEST_AUTH_KEY
                );
        ...
        describe('listPersons', () => {
            it('Sends the correct request', () => {
                expressPayments.account.listPersons('acct_123');
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
                    method: 'GET',
                    url: '/v1/accounts/acct_123/persons',
                    headers: {},
            ...
            it('Sends the correct request [with specified auth]', () => {
                expressPayments.account.listPersons('acct_123', TEST_AUTH_KEY);
                expect(expressPayments.LAST_REQUEST).to.deep.equal({
                    method: 'GET',
                    url: '/v1/accounts/acct_123/persons',
                    headers: {},
