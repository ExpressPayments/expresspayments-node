...
declare module 'expresspayments' {
    namespace ExpressPayments {
        ...
        interface Subscription {
            ...
            /**
             * A non-negative decimal between 0 and 100, with at most two decimal places. This represents the percentage of the subscription invoice subtotal that will be transferred to the application owner's ExpressPayments account.
             */
            ...
            /**
             * Either `charge_automatically`, or `send_invoice`. When charging automatically, ExpressPayments will attempt to pay this subscription at the end of the cycle using the default source attached to the customer. When sending an invoice, ExpressPayments will email your customer an invoice with payment instructions and mark the subscription as `active`.
             */
             ...
             */
            items: ApiList<ExpressPayments.SubscriptionItem>;

            /**
             * The most recent invoice this subscription has generated.
             */
            latest_invoice: string | ExpressPayments.Invoice | null;
            ...
            /**
             * You can use this [SetupIntent](https://docs.epayments.network/api/setup_intents) to collect user authentication when creating a subscription without immediate payment or updating a subscription's payment method, allowing you to optimize for off-session payments. Learn more in the [SCA Migration Guide](https://docs.epayments.network/billing/migration/strong-customer-authentication#scenario-2).
             */
            pending_setup_intent: string | ExpressPayments.SetupIntent | null;

            /**
             * If specified, [pending updates](https://docs.epayments.network/billing/subscriptions/pending-updates) that will be applied to the subscription once the `latest_invoice` has been paid.
             */
             ...
             */
            schedule: string | ExpressPayments.SubscriptionSchedule | null;
             ...
             *
             * If subscription `collection_method=charge_automatically` it becomes `past_due` when payment to renew it fails and `canceled` or `unpaid` (depending on your subscriptions settings) when ExpressPayments has exhausted all payment retry attempts.
             *
        ...
        namespace Subscription {
            interface AutomaticTax {
                /**
                 * Whether ExpressPayments automatically computes tax on this subscription.
                 */
                enabled: boolean;
            }
            ...
            interface PendingUpdate {
                ...
                subscription_items: Array<
                    ExpressPayments.SubscriptionItem
                > | null;
