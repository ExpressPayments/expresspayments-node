...
declare module 'expressplatby' {
    namespace ExpressPlatby {
         ...
         *
         * Related guide: [Creating subscriptions](https://expressplatby.cz/docs/billing/subscriptions/creating)
         */
        interface Subscription {
            ...
            /**
             * A non-negative decimal between 0 and 100, with at most two decimal places. This represents the percentage of the subscription invoice subtotal that will be transferred to the application owner's ExpressPlatby account.
             */
            ...
            /**
             * Either `charge_automatically`, or `send_invoice`. When charging automatically, ExpressPlatby will attempt to pay this subscription at the end of the cycle using the default source attached to the customer. When sending an invoice, ExpressPlatby will email your customer an invoice with payment instructions and mark the subscription as `active`.
             */
             ...
             */
            items: ApiList<ExpressPlatby.SubscriptionItem>;

            /**
             * The most recent invoice this subscription has generated.
             */
            latest_invoice: string | ExpressPlatby.Invoice | null;
            ...
            /**
             * You can use this [SetupIntent](https://expressplatby.cz/docs/api/setup_intents) to collect user authentication when creating a subscription without immediate payment or updating a subscription's payment method, allowing you to optimize for off-session payments. Learn more in the [SCA Migration Guide](https://expressplatby.cz/docs/billing/migration/strong-customer-authentication#scenario-2).
             */
            pending_setup_intent: string | ExpressPlatby.SetupIntent | null;

            /**
             * If specified, [pending updates](https://expressplatby.cz/docs/billing/subscriptions/pending-updates) that will be applied to the subscription once the `latest_invoice` has been paid.
             */
             ...
             */
            schedule: string | ExpressPlatby.SubscriptionSchedule | null;
             ...
             *
             * If subscription `collection_method=charge_automatically` it becomes `past_due` when payment to renew it fails and `canceled` or `unpaid` (depending on your subscriptions settings) when ExpressPlatby has exhausted all payment retry attempts.
             *
        ...
        namespace Subscription {
            interface AutomaticTax {
                /**
                 * Whether ExpressPlatby automatically computes tax on this subscription.
                 */
                enabled: boolean;
            }
            ...
            interface PaymentSettings {
                ...
                /**
                 * The list of payment method types to provide to every invoice created by the subscription. If not set, ExpressPlatby attempts to automatically determine the types to use by looking at the invoice's default payment method, the subscription's default payment method, the customer's default payment method, and your [invoice template settings](https://dashboard.expressplatby.cz/settings/billing/invoice).
                 */
            ...
            interface PendingUpdate {
                ...
                subscription_items: Array<
                    ExpressPlatby.SubscriptionItem
                > | null;
