...
declare module 'expressplatby' {
    namespace ExpressPlatby {
        ...
        interface PaymentIntent {
            ...
            /**
             * Settings to configure compatible payment methods from the [ExpressPlatby Dashboard](https://dashboard.expressplatby.cz/settings/payment_methods)
             */
            ...
            /**
             * Reason for cancellation of this PaymentIntent, either user-provided (`duplicate`, `fraudulent`, `requested_by_customer`, or `abandoned`) or generated by ExpressPlatby internally (`failed_invoice`, `void_invoice`, or `automatic`).
             */
             ...
             *
             * Refer to our docs to [accept a payment](https://expressplatby.cz/docs/payments/accept-a-payment?ui=elements) and learn about how `client_secret` should be handled.
             */
             ...
             */
            latest_charge?: string | ExpressPlatby.Charge | null;
            ...
            /**
             * Set of [key-value pairs](https://expressplatby.cz/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. For more information, see the [documentation](https://expressplatby.cz/docs/payments/payment-intents/creating-payment-intents#storing-information-in-metadata).
             */
            ...
            /**
             * The account (if any) for which the funds of the PaymentIntent are intended. See the PaymentIntents [use case for connected accounts](https://expressplatby.cz/docs/payments/connected-accounts) for details.
             */
            ...
            /**
             * Status of this PaymentIntent, one of `requires_payment_method`, `requires_confirmation`, `requires_action`, `processing`, `requires_capture`, `canceled`, or `succeeded`. Read more about each PaymentIntent [status](https://expressplatby.cz/docs/payments/intents#intent-statuses).
             */
            status: PaymentIntent.Status;

            /**
             * The data with which to automatically create a Transfer when the payment is finalized. See the PaymentIntents [use case for connected accounts](https://expressplatby.cz/docs/payments/connected-accounts) for details.
             */
        ...
        namespace PaymentIntent {
            ...
            interface NextAction {
                ...
                /**
                 * When confirming a PaymentIntent with ExpressPlatby.js, ExpressPlatby.js depends on the contents of this dictionary to invoke authentication flows. The shape of the contents is subject to change and is only intended to be used by ExpressPlatby.js.
                 */
