...
declare module 'expressplatby' {
    namespace ExpressPlatby {
        interface PlanCreateParams {
            ...
            /**
             * An identifier randomly generated by ExpressPlatby. Used to identify this plan when subscribing a customer. You can optionally override this ID, but the ID must be unique across all plans in your ExpressPlatby account. You can, however, use the same plan ID in both live and test modes.
             */
            id?: string;
        ...
        class PlansResource {
            ...
            ): Promise<ExpressPlatby.Response<ExpressPlatby.Plan>>;
            ...
            list(
                ...
                options?: RequestOptions
            ): ApiListPromise<ExpressPlatby.Plan>;
            list(options?: RequestOptions): ApiListPromise<ExpressPlatby.Plan>;
            ...
            del(
                ...
                options?: RequestOptions
            ): Promise<ExpressPlatby.Response<ExpressPlatby.DeletedPlan>>;
            del(
                id: string,
                options?: RequestOptions
            ): Promise<ExpressPlatby.Response<ExpressPlatby.DeletedPlan>>;
