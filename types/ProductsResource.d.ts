...
declare module 'expresspayments' {
    namespace ExpressPayments {
        interface ProductCreateParams {
            ...
            /**
             * Data used to generate a new [Price](https://docs.epayments.network/api/prices) object. This Price will be set as the default price for this product.
             */
            ...
            /**
             * An identifier will be randomly generated by ExpressPayments You can optionally override this ID, but the ID must be unique across all products in your ExpressPayments account.
             */
            id?: string;
        ...
        interface ProductUpdateParams {
             ...
             */
            attributes?: ExpressPayments.Emptyable<Array<string>>;
             ...
             * A list of up to 8 URLs of images for this product, meant to be displayable to the customer.
             */
            images?: ExpressPayments.Emptyable<Array<string>>;
             ...
             * The dimensions of this product for shipping purposes.
             */
            package_dimensions?: ExpressPayments.Emptyable<
             ...
             * A URL of a publicly-accessible webpage for this product.
             */
            url?: ExpressPayments.Emptyable<string>;
        }
        ...
        interface ProductListParams extends PaginationParams {
            ...
            /**
             * Only return products with the given IDs. Cannot be used with [starting_after](https://docs.epayments.network/api#list_products-starting_after) or [ending_before](https://docs.epayments.network/api#list_products-ending_before).
             */
            ids?: Array<string>;
        ...
        interface ProductSearchParams {
            /**
             * The search query string. See [search query language](https://docs.epayments.network/search#search-query-language) and the list of supported [query fields for products](https://docs.epayments.network/search#query-fields-for-products).
             */
            query: string;
        ...
        class ProductsResource {
            ...
            ): Promise<ExpressPayments.Response<ExpressPayments.Product>>;

            /**
             * Retrieves the details of an existing product. Supply the unique product ID from either a product creation request or the product list, and ExpressPayments will return the corresponding product information.
             */
            retrieve(
                id: string,
            ...
            list(
                ...
                options?: RequestOptions
            ): ApiListPromise<ExpressPayments.Product>;
            list(
                options?: RequestOptions
            ): ApiListPromise<ExpressPayments.Product>;
            ...
            del(
                ...
                ExpressPayments.Response<ExpressPayments.DeletedProduct>
            >;
            del(
                id: string,
                options?: RequestOptions
            ...
            /**
       * Search for products you've previously created using ExpressPayments' [Search Query Language](https://docs.epayments.network/search#search-query-language).
       ...
       */
            search(
                ...
                options?: RequestOptions
            ): ApiSearchResultPromise<ExpressPayments.Product>;
        }
    }
}
