...
declare module 'expressplatby' {
    namespace ExpressPlatby {
        interface ProductCreateParams {
            ...
            /**
             * Data used to generate a new [Price](https://expressplatby.cz/docs/api/prices) object. This Price will be set as the default price for this product.
             */
            ...
            /**
             * An identifier will be randomly generated by ExpressPlatby You can optionally override this ID, but the ID must be unique across all products in your ExpressPlatby account.
             */
            id?: string;
        ...
        interface ProductUpdateParams {
             ...
             */
            attributes?: ExpressPlatby.Emptyable<Array<string>>;
             ...
             * A list of up to 8 URLs of images for this product, meant to be displayable to the customer.
             */
            images?: ExpressPlatby.Emptyable<Array<string>>;
             ...
             * The dimensions of this product for shipping purposes.
             */
            package_dimensions?: ExpressPlatby.Emptyable<
             ...
             * A URL of a publicly-accessible webpage for this product.
             */
            url?: ExpressPlatby.Emptyable<string>;
        }
        ...
        interface ProductListParams extends PaginationParams {
            ...
            /**
             * Only return products with the given IDs. Cannot be used with [starting_after](https://expressplatby.cz/docs/api#list_products-starting_after) or [ending_before](https://expressplatby.cz/docs/api#list_products-ending_before).
             */
            ids?: Array<string>;
        ...
        interface ProductSearchParams {
            /**
             * The search query string. See [search query language](https://expressplatby.cz/docs/search#search-query-language) and the list of supported [query fields for products](https://expressplatby.cz/docs/search#query-fields-for-products).
             */
            query: string;
        ...
        class ProductsResource {
            ...
            ): Promise<ExpressPlatby.Response<ExpressPlatby.Product>>;

            /**
             * Retrieves the details of an existing product. Supply the unique product ID from either a product creation request or the product list, and ExpressPlatby will return the corresponding product information.
             */
            retrieve(
                id: string,
            ...
            list(
                ...
                options?: RequestOptions
            ): ApiListPromise<ExpressPlatby.Product>;
            list(
                options?: RequestOptions
            ): ApiListPromise<ExpressPlatby.Product>;
            ...
            del(
                ...
                options?: RequestOptions
            ): Promise<ExpressPlatby.Response<ExpressPlatby.DeletedProduct>>;
            del(
                id: string,
                options?: RequestOptions
            ): Promise<ExpressPlatby.Response<ExpressPlatby.DeletedProduct>>;
            ...
            /**
             * Search for products you've previously created using ExpressPlatby's [Search Query Language](https://expressplatby.cz/docs/search#search-query-language).
            ...
            search(
                ...
                options?: RequestOptions
            ): ApiSearchResultPromise<ExpressPlatby.Product>;
        }
    }
}
