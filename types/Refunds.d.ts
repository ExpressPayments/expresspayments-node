...
declare module 'expresspayments' {
    namespace ExpressPayments {
        ...
        interface Refund {
            ...
            /**
             * Reason for the refund, either user-provided (`duplicate`, `fraudulent`, or `requested_by_customer`) or generated by ExpressPayments internally (`expired_uncaptured_charge`).
             */
            ...
            /**
             * The transfer reversal that is associated with the refund. Only present if the charge came from another ExpressPayments account. See the Connect documentation for details.
             */
            ...
            /**
             * Status of the refund. For credit card refunds, this can be `pending`, `succeeded`, or `failed`. For other types of refunds, it can be `pending`, `requires_action`, `succeeded`, `failed`, or `canceled`. Refer to our [refunds](https://docs.epayments.network/refunds#failed-refunds) documentation for more details.
             */
            status: string | null;
             ...
             */
            transfer_reversal: string | ExpressPayments.TransferReversal | null;
        }
