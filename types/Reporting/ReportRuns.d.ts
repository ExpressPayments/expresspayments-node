...
declare module 'expressplatby' {
    namespace ExpressPlatby {
        namespace Reporting {
             ...
             * specific run parameters. Once the object is created, ExpressPlatby begins processing the report.
             * When the report has finished running, it will give you a reference to a file
             * where you can retrieve your results. For an overview, see
             * [API Access to Reports](https://expressplatby.cz/docs/reporting/statements/api).
             *
             * Note that certain report types can only be run based on your live-mode data (not test-mode
             * data), and will error when queried without a [live-mode API key](https://expressplatby.cz/docs/keys#test-live-modes).
             */
            interface ReportRun {
                /**
                ...
                /**
                 * The ID of the [report type](https://expressplatby.cz/docs/reports/report-types) to run, such as `"balance.summary.1"`.
                 */
                report_type: string;
                 ...
                 *  `status=succeeded`).
                 */
                result: ExpressPlatby.File | null;
